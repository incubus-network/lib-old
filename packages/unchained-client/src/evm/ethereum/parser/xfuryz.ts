...
import XFURYZ_STAKING_ABI from './abi/xfuryzStaking'
import { XFURYZ_STAKING_CONTRACT } from './constants'
...
export class Parser implements SubParser<Tx> {
  readonly abiInterface = new ethers.utils.Interface(XFURYZ_STAKING_ABI)
  ...
  async parse(tx: Tx): Promise<TxSpecific | undefined> {
    if (!txInteractsWithContract(tx, XFURYZ_STAKING_CONTRACT)) return

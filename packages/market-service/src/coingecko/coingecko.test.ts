...
describe('CoinGecko market service', () => {
  describe('findAll', () => {
    ...
    const xfury: CoinGeckoMarketCap = {
      id: 'shapeshift-xfury-token',
      symbol: 'xfury',
      name: 'ShapeShift XFURY Token',
      image: 'https://assets.coingecko.com/coins/images/9988/large/XFURY.png?1574330622',
    ...
    it('extract correct values for xfury', async () => {
      const xfuryResult = {
        price: '0.162007',
        marketCap: '59502764',
        changePercent24Hr: 3.74881,
      ...
      mockedAxios.get.mockResolvedValue({ data: [xfury] })
      const result = await coinGeckoMarketService.findAll()
      const xfuryAssetId = adapters.coingeckoToAssetIds('shapeshift-xfury-token')[0]
      expect(result[xfuryAssetId!]).toEqual(xfuryResult)
    })
  })
  ...
  describe('findByAssetId', () => {
    ...
    it('should return market data for XFURY', async () => {
      const result: MarketData = {
        price: '0.25007',
        marketCap: '59502764',
